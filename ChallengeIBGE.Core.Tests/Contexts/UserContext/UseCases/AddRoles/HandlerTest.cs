using ChallengeIBGE.Core.Contexts.UserContext.UseCases.AddRoles;
...
public class HandlerTest
{
    ...
    private readonly Request _validRequest = new(Guid.NewGuid(), "Admin");
    private readonly Request _validRoleAdded = new(new Guid("4c6a9c4a-ff72-499e-9e69-c6bfa0d23b2e"), "Admin");
    #endregion
    ...
    [Fact]
    public void Should_Fail_When_Role_Name_Is_Too_Large()
    {
    ...
    [Fact]
    public void Should_Succeed_When_Role_Name_Is_Valid()
    {
    ...
    {
        var result = await _handler.Handle(_validRoleAdded, new CancellationToken());
