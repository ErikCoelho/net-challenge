using ChallengeIBGE.Core.Contexts.UserContext.UseCases.SearchUser;
...
public class HandlerTest
{
    ...
    private readonly Request _validUserFound = new(new Guid("4c6a9c4a-ff72-499e-9e69-c6bfa0d23b2e"));
    #endregion
    ...
    [Fact]
    public async void Should_Succeed_When_User_Is_Found()
    {
        var response = await _handler.Handle(_validUserFound, new CancellationToken());
